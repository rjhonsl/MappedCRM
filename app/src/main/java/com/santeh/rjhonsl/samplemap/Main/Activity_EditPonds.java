...
public class Activity_EditPonds extends FragmentActivity  implements DatePickerDialog.OnDateSetListener{
    ...
    private int pondid, id, abw, survivalrate, quantity, area;
    private String specie, datestocked, culturesystem, remarks;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null){
            ...
            if (getIntent().hasExtra("survivalrate")){ survivalrate = getIntent().getIntExtra("survivalrate",0);}
